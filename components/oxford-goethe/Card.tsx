...
const styles = {
  ...
  section__div:
    "w-full sm:w-[600px] h-[250px] sm:h-[350px] border-double border-4 border-blue-300  rounded-lg shadow-xl shadow-slate-600 preserve-3d group my-rotate-y-180 duration-1000 flex flex-col justify-around",
