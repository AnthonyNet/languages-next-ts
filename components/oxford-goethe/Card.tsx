...
const styles = {
	...
	card__container:
		"relative w-full h-full mt-10-[vh] max-w-[600px] min-h-[280px] max-h-[280px] md:max-h-[400px]   border-double border-4   rounded-lg  preserve-3d group my-rotate-y-180 duration-1000 flex flex-col  __border_color",
