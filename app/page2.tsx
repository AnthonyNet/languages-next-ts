...
const styles = {
	section:
		"responsiveSection flex flex-col justify-center items-center  min-h-[100vh] h-auto sm:h-[90%]",
	card__div:
	...
	cardBack__div: "text-center flex flex-col items-center h-full  px-2 pb-24",
	cardBack__div__btn:
	...
	button:
		"btnBitcoin px-6 py-2 mt-[8rem] mb-8 font-semibold text-white rounded-full delay-1000 duration-1000 scale-0 group-hover:scale-125",
} as const;
		...
		<>
			<section className={styles.section}>
				...
				<h4 className="max-w-[300px] text-center">
					Hover the image to get Bitcoin real price
				</h4>
			</section>
