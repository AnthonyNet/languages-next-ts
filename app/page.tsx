...
const styles = {
	...
	h1__cover:
		"max-h-[100px] flex items-center justify-center sm:max-h-[500px] row-start-3 row-end-5 cursor-pointer __gradient __text_shadow rounded-tl-3xl rounded-br-3xl -skew-x-12 pr-2 __css_h1cover_height",
